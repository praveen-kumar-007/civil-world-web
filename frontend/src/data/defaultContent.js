...
export const defaultContent = {
  ...
  home: {
    ...
    hsbteResultPortal: {
      heading: "HSBTE Official Board Portal",
      title: "HSBTE Admissions, Results and Syllabus",
      description:
        "Access the official Haryana State Board of Technical Education portal for admissions, results, syllabus, notifications, and student services.",
      ctaLabel: "Open HSBTE Official Portal",
      url: "https://hsbte.org.in/",
      logo: "/images/hsbte-logo.png",
      details: [
        "View admission notifications and schedules",
        "Check semester results and updates",
        "Access syllabus, circulars, and board notices",
      ],
    },
